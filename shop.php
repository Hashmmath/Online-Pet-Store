  ...
  <!-- <header class="header">
    ...
    <?php
        ...
        if($check_name){
            while($row = mysqli_fetch_assoc($query_run))
            {
              ...
              <!-- <img src="./image/dog_1.jpg" alt=""> -->
                  <a href="pet_details.php?id=<?php echo $row['id'];?>"><img src="upload/uploads/<?php echo $row['img_url']?>" alt=""></a>

              <h4>Name: <?php echo $row['pet_name']?></h4>
                <h4>Owner Name: <?php echo $row['owner_name']?></h4>
                <h4>Mobile.no: <?php echo $row['mobile_no']?></h4>
      ...
      <div class="row">
          ...
          <a href="./product_shop.php" class="btn">Explore Products</a>
      </div>
  </div>
