...
?>
        ...
        $id = $_GET['id'];
        $query3 = "Select * from upload where id = '$id'";
        ...
        if($check_img){
            while($row = mysqli_fetch_assoc($query_run2))
            {
                ...
                <form action="" method="post">
                    ...
                    <input type="hidden" name="name" value="<?php echo $row['pet_name']; ?>">
        ...
        require 'upload/db_conn.php';
        $id = $_GET['id'];
        $query2 = "Select * from dog_details where id = '$id'";
        ...
        if($check_pet){
            while($row = mysqli_fetch_assoc($query_run1))
            {
                ...
                <!-- <form action="" method="post"> -->
                <div class="col-2">
                    <P><?php echo $row['animal']?></P>
                    <h1><?php echo $row['breed']?></h1>
                    <!--<select name="<?php echo $row['pet_name']?>"id="">
                    ...
                    <br>
                    <p><?php echo $row['pet_details']?></p>
                    <br>

                    <p>Height <?php echo $row['height']?></p>
                    <p>Weight<?php echo $row['weight']?></p>
                    <p>Life-Span<?php echo $row['life_span']?></p>
