...
<div class="ScriptTop">
    <div class="rt-container">
        ...
        <div class="col-rt-3">
            <ul>
                <li><a href="./owner_home.php" title="Back to tutorial page">Back to Home</a></li>
                <li><a href="./upload/shopdetails.php" title="Upload Pet">Upload Pet</a></li>
                <li><a href="./owner_login.html" title="Upload Pet">LOGOUT</a></li>
            </ul>
        </div>
    </div>
</div>
      ...
      <div class="col-lg-4">
        <div class="card shadow-sm">
          <div class="card-header bg-transparent text-center">
            <img class="profile_img" src="./image/dog_1.jpg" alt="student dp">
            <h3><?php echo $row['name']?></h3>
          </div>
          <div class="card-body">
            <p class="mb-0"><strong class="pr-1">User: </strong>Owner</p>
